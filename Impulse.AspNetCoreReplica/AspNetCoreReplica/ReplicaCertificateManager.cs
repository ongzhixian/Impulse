...
{
    /// <summary>
    /// https://github.com/dotnet/aspnetcore/blob/0c2ee920a17fc11ecc6b5fe8febe330262a2d69b/src/Shared/CertificateGeneration/CertificateManager.cs
    /// </summary>
    internal class ReplicaCertificateManager
    {
        ...
        public IList<X509Certificate2> ListCertificates(
            ReplicaCertificatePurpose purpose,
            StoreName storeName,
            ...
            DiagnosticInformation diagnostics = null)
        {
            ...
            try
            {
                using (var store = new X509Store(storeName, location))
                {
                    ...
                    switch (purpose)
                    {
                        case ReplicaCertificatePurpose.All:
                            matchingCertificates = matchingCertificates
                                .Where(c => HasOid(c, AspNetHttpsOid));
                            break;
                        case ReplicaCertificatePurpose.HTTPS:
                            matchingCertificates = matchingCertificates
                                .Where(c => HasOid(c, AspNetHttpsOid));
                            break;
                        default:

...
{
    /// <summary>
    /// https://github.com/dotnet/aspnetcore/blob/0c2ee920a17fc11ecc6b5fe8febe330262a2d69b/src/Servers/Kestrel/Core/src/Adapter/Internal/LoggingStream.cs
    /// </summary>
    internal class ReplicaLoggingStream : Stream
    {
        private readonly Stream _inner;
        private readonly ILogger _logger;

        public ReplicaLoggingStream(Stream inner, ILogger logger)
        {
            _inner = inner;
            _logger = logger;
        }

...
{
    internal class ReplicaConfigurationReader
    {
        ...
        public ReplicaConfigurationReader(IConfiguration configuration)
        {
        ...
        {
            if (Enum.TryParse<HttpProtocols>(protocols, true, out var result))
            {
                return result;
            }
